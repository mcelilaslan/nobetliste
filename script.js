...
function sendEmailWithRecipient() {
    ...
    google.script.run
        ...
        .sendEmail(recipient, base64Data, fileName);
}
...
function autoAssignDuties() {
    ...
    const CLOUD_FUNCTIONS_URL = 'https://deneme-174463354439.europe-west4.run.app'; // Cloud Functions URL'niz
    ...
    function uploadPersonnel(event) {
        ...
        loadingMessage.textContent = 'Nöbetler atanıyor...';
        ...
        reader.onload = function(e) {
            ...
            google.script.run
                ...
                .uploadPersonnelServer(base64String);
        };
    ...
    function downloadPersonnel() {
        google.script.run
            ...
            .downloadPersonnelServer(persons);
    }
